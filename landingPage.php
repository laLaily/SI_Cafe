    ...
    <main>
        <section class="home">
            <section class="description">
                <h1>CAFE TERSERAH</h1>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sunt maiores animi obcaecati excepturi, delectus
                    debitis reiciendis temporibus perspiciatis voluptas atque odio quibusdam quam ipsam, velit dolores quos soluta
        ...
        <section class="booking">
            <div class="reservation">
                ...
                <div class="link">
                    <a href="./reservation.html">Learn More</a>    
                </div>
            </div>
            <div class="dine">
                <div class="head">
                ...
                <div class="link">
                    <a href="./dine-in.html">Learn More</a>
                </div>
            </div>
        </section>
    </main>
